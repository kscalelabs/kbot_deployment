...
class Motion:
    ...
    def get_next_motion_frame(self) -> Tuple[list[float], list[float]] | None:
        """Get the next motion frame.
        
        Returns:
            Tuple of (commands, positions) as lists,
        ...
        commands_array = [commands.get(cmd, 0.0) for cmd in COMMANDS]
        positions_array = [positions.get(joint, 0.0) for joint in POSITIONS]
